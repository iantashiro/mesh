...
module.exports = createHelpEmbed = () => new EmbedBuilder()
    .setColor('#0099ff')
    ...
    .addFields(
        { name: "Commands", value: "**@sh start**: creates a text-channel based on the host and begins a game." },
    ...
    .setFooter({ text: "This bot is still in development. Avoid deleting Messages or Embeds directly from the bot." });
